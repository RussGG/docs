...
* the mmeowlink port (if using it)
  * The explorer board port is /dev/spidev5.1 
   *if using explorer board, see [here](https://github.com/oskarpearson/mmeowlink/wiki/Installing-MMeowlink) for other port options)
